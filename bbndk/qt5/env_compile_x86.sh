...
PATH="$QNX_HOST/usr/bin:$QNX_CONFIGURATION/bin:$BASE_DIR/features/$LATEST_LINUX_JRE/jre/bin:$QNX_HOST/usr/python32/bin:$QNX_TARGET/x86/usr/lib:$QNX_TARGET/x86/lib:$PATH"
LD_LIBRARY_PATH="$QNX_HOST/usr/lib:$QNX_TARGET/x86/usr/lib:$QNX_TARGET/x86/lib:$LD_LIBRARY_PATH"
CPUVARDIR=$ARCH
QDE="$BASE_DIR"
